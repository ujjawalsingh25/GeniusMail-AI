// ____________   NEXT JS  _______________________________________________
//                                                                        |      
...
// ______________    shadcn   __________________________________________________
//                                                                              |
    // npx shadcn@latest init        -->> Run the CLI                           |
    // npm install next-themes       -->> themes for Dark Mode                  |
// ---- -------   Add Components using shadcn  -------------------------------- | 
// npx shadcn@latest add [component]    -->> Components that we want to add     |
// ---------------------------------------------------------------------------- |
    // npx shadcn@latest add accordion       -->> Accordion                     |
    // npx shadcn@latest add alert           -->> Alert                         |
    // npx shadcn@latest add alert-dialog    -->> Alert-dialog                  |
    // npx shadcn@latest add aspect-ratio    -->> Aspect-Ratio                  |
    // npx shadcn@latest add avatar          -->> Avatar                        |
    // npx shadcn@latest add badge           -->> Badge                         |
